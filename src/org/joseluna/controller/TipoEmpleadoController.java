...
public class TipoEmpleadoController  implements Initializable {
    ...
    cargarDatos();
     ...
     public void cargarDatos(){
      ...
      public ObservableList <TipoEmpleado>getTipoEmpleado(){
          ...
          try{
              PreparedStatement procedimiento = Conexion.getIntance().getConexion().prepareCall("{Call sp_ListarTipoEmpleado()}");
     ...
     public void guardar(){
         ...
         try{
             PreparedStatement procedimiento = Conexion.getIntance().getConexion().prepareCall("{call sp_AgregarTipoEmpleado(?)}");
 ...
 public void actualizar(){
     try{
         PreparedStatement procedimiento = Conexion.getIntance().getConexion().prepareCall("{call sp_ActualizarTipoEmpleado(?)}");
