...
public class ProductosController implements Initializable{
   ...
   public  void nuevo (){
    ...
    public void guardar(){
         ...
         try{
             PreparedStatement procedimiento = Conexion.getIntance().getConexion().prepareCall("{call sp_AgregarProductos(?,?)}");
    ...
    public void editar(){
     switch (tipoDeOperaciones){
        ...
        public void actualizar(){
            try{
            PreparedStatement procedimiento = Conexion.getIntance().getConexion().prepareCall("{call sp_ActualizarProductos(?,?,?)}");
