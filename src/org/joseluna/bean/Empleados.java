...
public class Empleados {
    ...
    public Empleados(int codigoEmpleado, String numeroEmpleado, String apellidoEmpleado, String nombreEmpleado, String direccionEmpleado, String telefonoContacto, String gradoCocinero, int codigoTipoEmpleado) {
